...
export default function Operations({ currentUser, roles }) {
  ...
  const filterKPI = (tab, key) => canAccessKPI(currentUser, "/operations", tab, key, roles);
  ...
  ].filter((c) => filterKPI("admission", c.key));
  ...
  ].filter((c) => filterKPI("emergency", c.key));
  ...
  ].filter((c) => filterKPI("insurance", c.key));
    ...
    <div className="fade-in bg-green-50 p-6">
      ...
      {activeTab === defaultTab && (
        <>
          ...
          { (filterKPI("overview", "ot-chart") || filterKPI("overview", "key-metrics")) && (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-8">
              {filterKPI("overview", "ot-chart") && <OperationsChart />}
              {filterKPI("overview", "key-metrics") && (
          ...
          {/* ALERTS */}
          {filterKPI("overview", "executive-alerts") && (
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 mt-8">
              <h2 className="text-2xl font-bold mb-5 text-gray-800">🚨 Executive Alerts</h2>
              <div className="space-y-3">
      ...
      {activeTab === "upload" && (
        <div className="grid lg:grid-cols-2 gap-6">
          {filterKPI("upload", "widget") && <UploadWidget title="Upload Operations MIS Data" onDataLoaded={handleDataLoaded} />}
